                ...
                <div className="p-4 rounded-lg bg-white w-[50vw] h-100% px-[30px] mb-[30px]">
                    ...
                    {isEditing ? (
                                    ...
                                    try {
                                        await axiosInstance.put(`/posts/update`, {
                                            ...
                                            title: JSON.stringify({
                                                ...
                                                locations: locationsInput.split(',').map((s: string) => s.trim()),
                                                hotels: hotelsInput.split(',').map((s: string) => s.trim()),
                                            }),
                        ...
                        <div className="w-100% border-[var(--color-black)] flex flex-col">
                            <PostInteraction postId={post._id} likes={post.likes} comments={post.comments} />
                            {/* {!showBox && (
                <div
