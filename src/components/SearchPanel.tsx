            ...
            <div className="flex-grow overflow-y-auto border-t border-gray-200 pt-3 pb-4">
                ...
                <div className="flex-grow overflow-y-auto border-t border-gray-200 pt-3 pb-4">
                    {loading ? (
                        ...
                        <>
                            ...
                            <ul>
                                {searchResults.map((user) => (
                                    <li key={user._id} className="flex justify-between items-center py-1.5 mb-1 group">
                        ...
                        <p className="text-sm text-gray-500">게시글 검색은 아직 구현되지 않았습니다.</p>
                    )}
                </div>
                <h3 className="text-base font-bold mb-2 text-black-700">최근 검색 항목</h3>
                <ul>
                    ...
                    <li className="flex justify-between items-center py-1.5 mb-1 group">
                        <div className="flex items-center gap-2 cursor-pointer hover:text-blue-600">
                            <img
                                ...
                                className="w-8 h-8 rounded-full mr-1"
                            />
                            <span className="text-gray-800 cursor-pointer hover:text-blue-600">채널 주인 2</span>
                        </div>
                        <button aria-label="Remove search item">✕</button>
                    </li>
                    <li className="flex justify-between items-center py-1.5 mb-1 group">
                        <div className="flex items-center gap-2 cursor-pointer hover:text-blue-600">
                            <img
                                ...
                                className="w-8 h-8 rounded-full mr-1"
                            />
                            <span className="text-gray-800 cursor-pointer hover:text-blue-600">채널 주인 3</span>
                        </div>
                        <button aria-label="Remove search item">✕</button>
                    </li>
                </ul>
