import testsignInImg from '../assets/images/signInImg.png';
import testSearch from '../assets/icons/Search.svg';
import testSetting from '../assets/icons/setting.svg';
// 임시 프로필,아이콘 사진
        ...
        <div className="w-full max-w-[1000px] mx-auto p-4 mt-[55px]">
            ...
            <div className="flex flex-wrap md:flex-nowrap items-start gap-5">
                ...
                <div className="w-[170px] h-[170px] rounded-full overflow-hidden">
                    <img src={testsignInImg} alt="프로필 사진" className="w-full h-full object-cover" />
                </div>

                {/* 태그, 소개글 */}
                <div className="w-[365px]">
                    <div className="flex items-center gap-3 mb-8">
                        <Button className="w-[174px] h-[31px] border border-[#60B5FF] text-[#60B5FF] px-3 py-1 rounded-[19px] text-sm relative font-bold">
                            <img
                                src={testSearch}
                                alt="아이콘"
                ...
                <div className="flex flex-col gap-2 w-[273px] ml-28">
                    <div className="flex">
                        <div className="w-[88px] h-[33px] text-center text-[20px] text-black">여정 : 349</div>
                        <div className="w-[88px] h-[33px] text-center text-[20px] text-black">팔로워 : 0</div>
                        <div className="w-[88px] h-[33px] text-center text-[20px] text-black">팔로잉 : 0</div>
                    </div>
            ...
            <hr className="mt-8 mb-10 border-[#67B8FF]" />
